...
class UserSearch extends User
{
    ...
    {
        return [
            [['id', 'status', 'created_at', 'updated_at', 'role', 'score', 'money', 'solved_tasks'], 'integer'],
            [['username', 'email', 'password_hash', 'auth_key', 'password_reset_token', 'surname', 'name', 'middlename'], 'safe'],
        ];
    }
